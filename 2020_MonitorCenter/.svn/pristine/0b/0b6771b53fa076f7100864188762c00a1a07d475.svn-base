...
//        Tool.out(this.getName() + " starting shutdown...");
...
//            }
//        }
//        Tool.out(this.getName() + "--> shutdown completed...");
//    }
...
//                            Tool.out("PoolWorker " + this.getName() + " Dang cho ThreadQueue has more element...");
                            waitTaskCount++;
                            THREAD_QUEUE.wait();
                            waitTaskCount--;
...
//                    Tool.out("Tang completedTaskCount 1");
                    completedTaskCount++;       // Tang Completed Count len 1
                }
            }
            waitTaskCount--;
            activeCount--;
//            Tool.out("Tang completedTaskCount 2");
            completedTaskCount++;
            Tool.out(this.getName() + " is End..");
        }
    }
}
