...
public class HtmlTool {
    ...
    public static void main(String[] args) throws Exception {
        Tool.out(html2text("<RequestId>1235</RequestId><ErrorId>1</ErrorId><ErrorDesc>Thành công</ErrorDesc>"));
    }
...
//        Tool.out("length(): " + contentsHtml.length());
...
//            Tool.out("--idx_lon--" + idx_lon + "--idx_be:--" + idx_be + "--idx_cheo--:" + idx_cheo);
            if (idx_lon < idx_be) {
    ...
    public String htmlParse(String contentsHtml, int index_cut) {
        ...
        try {
            ...
            HtmlTool web = new HtmlTool();
//            Tool.out("length(): " + contentsHtml.length()+"--content:--"+contentsHtml.substring(0,19));
            if (contentsHtml.length() > idx_cut) {
...
//                        Tool.out("33--fstText:" + (idx_cut + idx_lst + 5) + "--lstText:" + (idx_cut + idx_lst + 5));
...
//                        sReturn = contentsHtml.substring(0, iCuted) + "--chen vao giua--" + web.htmlParse(contentsHtml.substring(iCuted),idx_cut);
                        ...
                        //<img/> ko nam trong doan
//                        Tool.out("22--<img/> ko nam trong doan");
