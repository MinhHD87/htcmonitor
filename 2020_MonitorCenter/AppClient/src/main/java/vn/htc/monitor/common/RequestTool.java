...
public class RequestTool {
    ...
    public static int getInt(HttpServletRequest request, String param) {
        ...
        try {
            ...
            tem = 0;
            Tool.out("RequestTool: getInt " + e.getMessage() + " | URL" + Tool.getCurrentURL(request));
        }
        return tem;
    }
    ...
    public static boolean getBoolean(HttpServletRequest request, String param) {
        ...
        try {
            ...
            tem = false;
            Tool.out("RequestTool: getBoolean " + e.getMessage() + " | URL" + Tool.getCurrentURL(request));
        }
        return tem;
    }
    ...
    public static int getInt(HttpServletRequest request, String param, int defaultVal) {
        ...
        try {
            ...
            Tool.out("RequestTool: getInt - defaultVal:" + e.getMessage() + " | URL" + Tool.getCurrentURL(request));
            tem = defaultVal;
        }
        return tem;
    }
    ...
    public static long getLong(HttpServletRequest request, String param) {
        ...
        try {
            ...
            Tool.out("RequestTool: getLong:" + e.getMessage() + " | URL " + Tool.getCurrentURL(request));
            tem = 0;
        }
        return tem;
    }
    ...
    public static double getDouble(HttpServletRequest request, String param) {
        ...
        try {
            ...
            Tool.out("RequestTool: getDouble:" + e.getMessage());
            tem = 0;
        }
        return tem;
    }
    ...
    public static String getString(HttpServletRequest request, String param) {
        ...
        try {
            ...
            Tool.out("RequestTool: getstring:" + e.getMessage());
            str = "";
        }
        return str;
    }
