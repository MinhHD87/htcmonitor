                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <tr ng-repeat="oneAcc in datas">
                                    ...
                                    <td  class="img-center"><a href="${pageContext.request.contextPath}/admin/sys-account/user-privileges?id={{oneAcc.accId}}">${Lang['generic.role']}</a></td>
                                    <td class="img-center">
                                    ...
                                    <td style="width: 70px">
                                        ...
                                        <a  ng-click="delete(oneAcc.accId)" href="" title="Delete">
