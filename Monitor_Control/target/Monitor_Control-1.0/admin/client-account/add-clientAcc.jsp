...
<div id="content">
    <div id="content-header">
        <div id="breadcrumb">
            ...
            <a cl href="<c:url value="#"/>" class="current">Thêm mới Tài Khoản Đại Lý(Khách Hàng)</a>
        </div>
    </div>
                            ...
                            <table class="table table-bordered table-striped"> 
                                <tbody>
                                    ...
                                    <tr>
                                        <td>TpsCall</td>
                                        <td colspan="3">
                                            vte &nbsp;<input type="text" name="vte" value = "${tpsCall.vte}" style="width: 25px" value/>&nbsp;&nbsp;&nbsp;
                                            vms &nbsp;<input type="text" name="vms" value = "${tpsCall.vms}" style="width: 25px" value/>&nbsp;&nbsp;&nbsp;
                                            gpc &nbsp;<input type="text" name="gpc" value = "${tpsCall.gpc}" style="width: 25px" value/>&nbsp;&nbsp;&nbsp;
                                            vnm &nbsp;<input type="text" name="vnm" value = "${tpsCall.vnm}" style="width: 25px" value/>&nbsp;&nbsp;&nbsp;
                                            bl &nbsp;<input type="text" name="bl" value = "${tpsCall.bl}" style="width: 25px" value/>&nbsp;&nbsp;&nbsp;
                                            ddg &nbsp;<input type="text" name="ddg" value = "${tpsCall.ddg}" style="width: 25px" value/>&nbsp;&nbsp;&nbsp;
                                        </td>
                                    </tr>
                                    <tr>
